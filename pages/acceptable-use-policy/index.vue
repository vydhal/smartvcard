  ...
  >
    <div class="px-4">
      ...
      <div class="max-w-screen-sm">
        ...
        <br />
        <h2 class="font-extrabold text-2xl">Acceptable Use Policy</h2>
        <br />
        <p>
          ...
          provided by BizViz under any ongoing agreement. It’s designed to
          protect us, our customers, and the general Internet community from
          unethical, irresponsible, and illegal activity.
        </p>
        <br />
        <p>
          BizViz customers found engaging in activities prohibited by this
        ...
        <br />
        <p>This policy was last reviewed on 25 July 2021.</p>
        <br />
        <h3 class="font-extrabold text-2xl">Fair use</h3>
        <br />
        <p>
        ...
        <br />
        <h3 class="font-extrabold text-2xl">Customer accountability</h3>
        <br />
        <p>
        ...
        <br />
        <h3 class="font-extrabold text-2xl">Prohibited activity</h3>
        <br />
        ...
        <br />
        <ol type="i" style="list-style: lower-roman; padding: 10px 0 10px 20px">
          <li>
        ...
        <br />
        <h4 class="font-extrabold text-2xl">
          Unauthorized use of BizViz property
        </h4>
        <br />
        <p>
          We prohibit the impersonation of BizViz, the representation of a
          significant business relationship with BizViz, or ownership of any
          BizViz property (including our Products and brand) for the purpose of
          fraudulently gaining service, custom, patronage, or user trust.
        </p>
        <br />
        <h3 class="font-extrabold text-2xl">About this policy</h3>
        <br />
        <p>
...
export default {
  ...
  head: {
    titleTemplate: 'Acceptable Use Policy  - %s',
    meta: [
      { charset: 'utf-8' },
