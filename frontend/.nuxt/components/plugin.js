...
const components = {
  ...
  CustomButton: () => import('../..\\components\\CustomButton.vue' /* webpackChunkName: "components/custom-button" */).then(c => c.default || c),
  CustomButtonShowCase: () => import('../..\\components\\CustomButtonShowCase.vue' /* webpackChunkName: "components/custom-button-show-case" */).then(c => c.default || c),
  CustomCard: () => import('../..\\components\\CustomCard.vue' /* webpackChunkName: "components/custom-card" */).then(c => c.default || c),
