...
export { default as CustomButtonShowCase } from '../..\\components\\CustomButtonShowCase.vue'
export { default as CustomCard } from '../..\\components\\CustomCard.vue'
...
export const LazyCustomButton = import('../..\\components\\CustomButton.vue' /* webpackChunkName: "components/custom-button" */).then(c => c.default || c)
export const LazyCustomButtonShowCase = import('../..\\components\\CustomButtonShowCase.vue' /* webpackChunkName: "components/custom-button-show-case" */).then(c => c.default || c)
export const LazyCustomCard = import('../..\\components\\CustomCard.vue' /* webpackChunkName: "components/custom-card" */).then(c => c.default || c)
