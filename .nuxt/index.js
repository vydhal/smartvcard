...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Smart vCard","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Create beautiful, responsive HTML‑based digital business cards that can be hosted on your domain or ours"},{"hid":"msapplication-TileColor","name":"msapplication-TileColor","property":"msapplication-TileColor","content":"#111827"},{"hid":"msapplication-TileImage","name":"msapplication-TileImage","property":"msapplication-TileImage","content":"\u002Ffavi.png"}],"link":[{"rel":"icon","type":"image\u002Fpng","href":"\u002Ffavi.png"},{"rel":"apple-touch-icon","sizes":"180x180","href":"\u002Fapple-touch-icon.png"},{"rel":"mask-icon","color":"#111827","href":"\u002Fsafari-pinned-tab.svg"}],"script":[{"src":"\u002Fqrcode.min.js"},{"src":"https:\u002F\u002Fjs.stripe.com\u002Fv3"}],"style":[]},
